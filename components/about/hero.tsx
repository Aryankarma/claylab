...
export default function Hero() {
  return (
    <section className="relative w-full h-screen flex items-center overflow-hidden">
      ...
      <div className="flex flex-col gap-6 mx-14 mt-32 text-start max-w-4xl z-10">
        <p style={{ fontWeight: "100" }} className="text-5xl md:text-7xl max-w-2xl  text-white mb-6 leading-[-0.5] font-sourceSans font-thin" >
          It started with three teachers, a handful of students, and a vision full of hope.
        </p>
        <h3 className="text-5xl md:text-7xl mb-[-32] text-white font-roughScript z-[5]">Our Story</h3>
        <p style={{ fontWeight: "100" }} className="text-base md:text-sm text-white/70 mb-8 max-w-6xl z-[10] font-sourceSans font-thin">
